def classify(X_train, y_train, X_test, y_test, X_without_ground_truth, configs):
    ...
    X_without_ground_truth = X_without_ground_truth.values
    ...
    # d_test_2 = xgb.DMatrix(, label=[1] * len(X_without_ground_truth), nthread=2)
    ...
    prob_y_without_ground_truth = \
        model.predict(xgb.DMatrix(X_without_ground_truth, label=[1]*len(X_without_ground_truth), nthread=2))
    print("XGBoost Training done !")

    return model, prob_y_train, prob_y_test, prob_y_without_ground_truth
